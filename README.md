...
```javascript
// Basic Information
valentineName: "Dear Snehaa"                    // Your Valentine's name
...
questions: {
    first: {
        ...
        secretAnswer: "I don't like you, I like you moreeeeeee! ❤️"  // Hidden message
    },
    second: {
...
// Final Celebration
celebration: {
    title: "Yayyyyyyyyyyy!!!!",     // Celebration title
    message: "Be ready on February 14th. I’ll come pick you up.... don’t be late",          // Celebration message
